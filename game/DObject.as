package game
{
	...
	public class DObject extends DisplayObject3D
	{
		...
		public function DObject(clase:*,text:String,precise:Boolean=false)
		{
		
			this._clase =  new Collada(XML(new clase()));
			this._id = id; 
			
			this.mat = new BitmapFileMaterial(text,precise);
